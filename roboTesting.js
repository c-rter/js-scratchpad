    ...
    if (route.length == 0) {
        ...
        for (let parcel of parcels) {
            ...
            if (parcel.place == place) {
                ...
                if (bestRoute.length>route.length) {
                    bestRoute = route;
                }
...
function compareRobots(robot1, memory1, robot2, memory2) {
    ...
    for (i = 0; i < 100; i++) {
        ...
        shareState = VillageState.random();
        robot1c += runRobot2(shareState, robot1, memory1);
        robot2c += runRobot2(shareState, robot2, memory2);

    }

    console.log(`Robot 1 Average: ${robot1c / 100}`);
    console.log(`Robot 2 Average: ${robot2c / 100}`);
}
